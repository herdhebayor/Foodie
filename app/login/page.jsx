...
function Register() {
  ...
  if(logingin){
    return <div className="w-screen h-screen bg-white p-6">
      <div className="w-full md:w-120 text-slate-900 shadow-lg border h-30 text-center flex justify-center items-center mx-auto border-gray-200 mt-6">
  ...
  return (
    <div className='w-screen h-screen bg-white'>
        <div className='flex justify-between items-center h-full w-full'>
            <div className='text-slate-900 w-full md:w-[30%] min-w-130 max-w-full h-full flex justify-center items-center '>
              <div className='p-6 px-10 w-full min-w-120'>
                <div className='w-full mx-auto  max-w-120 border border-gray-100 shadow-xl  py-4 px-6 rounded-md'>
                  ...
                  {/* header */}
                    ...
                    <button 
                      ...
                      className='text-orange-500 border border-gray-100 p-4 cursor-pointer disabled:cursor-not-allowed flex disabled:bg-gray-200 items-center
                      justify-center w-full rounded-lg mt-6 bg-orange-100 font-bold shadow-md'
                      >
                        {googleLoading ? <> <ButtonLoading className='mr-2'/> Signing in... </> : <><FcGoogle size={30} className='mr-4'/> Signin with Google</>}
                    </button>
