      ...
      <div className='container mx-auto block px-10 py-6'>
        <div className='flex items-center justify-center gap-6'>
          <div className='text-sm w-35 flex flex-col relative md:w-50 text-center items-center p-2 py-10 rounded-md'>
            <img src='/images/assiChef.jpg' className='w-25  h-25 mb-4 rounded-full bg-black/10  mx-auto' alt='product'/>
          ...
          <div className='text-sm w-35 flex flex-col relative md:w-50 text-center items-center p-2 py-10 rounded-md'>
            <img src='/images/headChef.jpg' className='w-25  h-25 mb-4 rounded-full bg-black/10  mx-auto' alt='product'/>
            <div className='flex flex-col  text-slate-900'>
          ...
          <div className='text-sm w-35 flex flex-col relative md:w-50 text-center items-center p-2 py-10 rounded-md'>
            <img src='/images/pastryChef.jpg' className='w-25  h-25 mb-4 rounded-full bg-black/10  mx-auto' alt='product'/>
            <div className='flex flex-col  text-slate-900'>
