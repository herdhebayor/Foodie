...
function EditProfile({user}) {
  ...
  return (
    <div className='bg-white w-full h-full flex py-8 items-center justify-center'>
        {/* Profile edit */}
        <div className='w-full h-full rounded-md  text-slate-900 p-6'>
            ...
            <form className='flex flex-col gap-4'>
                ...
                <div className='flex flex-col gap-1'>
                    ...
                    <input type='text' defaultValue={user?.username || ''} id='username' placeholder='Enter your username' className='w-full px-4 py-2 rounded-md border border-gray-400 focus:outline-none focus:ring-2 focus:ring-green-400'/>
                </div>
                <div className='flex flex-col gap-1'>
                    <label htmlFor='email' className='text-slate-900 font-semibold'>Email</label>
                    <input type='email' defaultValue={user?.email || ''} id='email' placeholder='Enter your email' className='w-full px-4 py-2 rounded-md border border-gray-400 focus:outlinenone focus:ring-2 focus:ring-green-400'/>
                </div>
                <div>
                ...
                <div className='flex gap-4'>
                    ...
                    <div>
                        ...
                        <input type='text' id='city' defaultValue={user?.city || ''} name='city' className='w-full px-4 py-2 rounded-md border border-gray-400 focus:outline-none focus:ring-2 focus:ring-green-400'/>
                    </div>
                </div>
                <div>
                    <label htmlFor='street' className='text-slate-900 font-semibold'>Street</label>
                    <input type='text' id='street' defaultValue={user?.street || user.address || ' '} name='street' className='w-full px-4 py-2 rounded-md border border-gray-400 focus:outline-none focus:ring-2 focus:ring-green-400'/>
                </div>
            </form>
